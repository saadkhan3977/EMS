    ...
    <section class="content">
        ...
        <div class="box">
            {{-- <div class="box-header with-border">
                <h3 class="box-title">
                <a href="/admin/timeschedules/create" class="btn btn-default btn-xm" data-toggle="tooltip" title="Create"><i class="fa fa-plus"></i></a>
                </h3>
                <div class="box-tools">
            ...
            <div class="box-body table-responsive">
                ...
                <table id="dataTable" class="table table-bordered">
                    ...
                    <tr>
                        <td>{{ $timeSchedule->time_schedule }}</td>
                        <td>
                            <form method="post" action="/admin/timeschedules/{{ $timeSchedule->id }}/status">
                                {{ csrf_field() }}
                                {{ method_field('put') }}
                                @if($timeSchedule->status == 'ACTIVE')
                        ...
                        <td>
                            <form method="post" action="/admin/timeschedules/{{ $timeSchedule->id }}">
                                {{ csrf_field() }}
                                {{ method_field('delete') }}
                                <a href="/admin/timeschedules/{{ $timeSchedule->id }}/edit" class="btn btn-info btn-flat btn-sm"> <i class="fa fa-edit"></i></a>

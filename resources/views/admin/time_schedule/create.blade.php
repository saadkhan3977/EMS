...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <!-- SELECT2 EXAMPLE -->
    <!-- form start -->
    <form name="formAdd" id="formAdd" method="POST" action="/admin/timeschedules" enctype="multipart/form-data">
      @csrf
            ...
            <div class="col-xs-12">
              {{-- <div class="form-group">
                ...
                <div class="form-group {{ $errors->has('time_schedule') ? 'has-error' : null }}">
                  ...
                  <input type="text" name="time_schedule" class="form-control" id="time_schedule" placeholder="Time Schedule">

...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <!-- SELECT2 EXAMPLE -->
    <!-- form start -->
    <form name="formEdit" id="formEdit" method="post" action="/admin/employees/{{ $user->id }}" enctype="multipart/form-data">
      {{ csrf_field() }}
      {{ method_field('put') }}
          ...
          <div class="row">
            <div class="col-xs-6">
              <div class="form-group {{-- {{ $errors->has('employee_id') ? 'has-error' : null }} --}}">
                ...
                <input type="text" name="employee_id" class="form-control" id="employee_id" placeholder="employee id"  value="{{ $user->employee_id }}" readonly>
              ...
              <div class="form-group {{ $errors->has('slug') ? 'has-error' : null }}">
                ...
                <input type="text" name="slug" class="form-control" id="slug" placeholder="Slug"  value="{{ $user->slug }}">
              ...
              <div class="form-group {{ $errors->has('dob') ? 'has-error' : null }}">
                ...
                @else
                <input type="text" name="dob" class="form-control" id="dob" placeholder="Date of Birth"  value="{{ $user->dob }}">
                @endif
              ...
              <div class="form-group {{ $errors->has('facebook_id') ? 'has-error' : null }}">
                ...
                <input type="text" name="facebook_id" class="form-control" id="facebook_id" placeholder="Facebook ID"  value="{{ $user->facebook_id }}">
              </div>
              
              <div class="form-group {{ $errors->has('linkedin_id') ? 'has-error' : null }}">
                <label for="linkedin_id">LinkedIn ID</label>
                <input type="text" name="linkedin_id" class="form-control" id="linkedin_id" placeholder="LinkedIn ID"  value="{{ $user->linkedin_id }}">
              </div>
              ...
              <div class="form-group {{ $errors->has('address') ? 'has-error' : null }}">
                <label>Address</label>
                <textarea name="address" id="address" class="form-control" rows="5" placeholder="Enter ...">{{ $user->address }}</textarea>
              </div>  
            </div>
            ...
            <div class="col-xs-6">
              <div class="form-group {{-- {{ $errors->has('joining_date') ? 'has-error' : null }} --}}">
                ...
                <input type="text" name="joining_date" class="form-control" id="joining_date" placeholder="joining date"  value="{{$user->joining_date}}" readonly>
              ...
              <div class="form-group {{ $errors->has('time_schedule') ? 'has-error' : null }}">
                ...
                <select name="time_schedule" id="time_schedule" class="form-control select2" style="width: 100%;">
                  <option value="{{ $user->time_schedule }}">{{ $user->time_schedule }}</option>
              ...
              <div class="form-group {{ $errors->has('departments') ? 'has-error' : null }}">
                ...
                <select name="departments" id="departments" class="form-control select2" style="width: 100%;">
                  <option value="{{ $user->departments }}">{{ $user->departments }}</option>
              ...
              <div class="form-group {{ $errors->has('merital') ? 'has-error' : null }}">
                ...
                <select name="merital" id="merital" class="form-control select2" style="width: 100%;">
                  <option value="{{ $user->merital }}">{{ $user->merital }}</option>
                   @if($user->merital == 'Unmarried')
                    <option value="Married">Married</option>
                  @endif
                  @if($user->merital == 'Married')
              ...
              <div class="form-group {{ $errors->has('salary') ? 'has-error' : null }}">
                ...
                <input type="text" name="salary" class="form-control" id="salary" placeholder="Salary" value="{{ $user->salary }}">
              </div>
              

              <div class="form-group">
                <label>Admin</label>
                <select name="admin" id="admin" class="form-control select2" style="width: 100%;">
                  @if($user->admin == 1)
              ...
              <div class="form-group">
                ...
                <input type="text" name="password" class="form-control" id="password" placeholder="Password" value="{{ $user->password }}" readonly>
              </div>
            </div>
          </div>

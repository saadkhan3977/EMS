  ...
  @endif
    ...
    <section class="content">
      <div class="row">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="{{ url('admin/mailbox') }}"><i class="fa fa-inbox"></i> Inbox
                  <span class="label label-primary pull-right">{{ $mails->count() }}</span></a></li>
                <li><a href="{{ url('admin/mailbox/sent') }}"><i class="fa fa-envelope-o"></i>
                  <span class="label label-success pull-right">{{ $mails->count() }}</span> Sent</a></li>
                <li><a href="#"><i class="fa fa-file-text-o"></i> 
                  <span class="label label-warning pull-right">{{ $mails->count() }}</span> Drafts</a></li>
                </li>
                <li><a href="#"><i class="fa fa-trash-o"></i> 
                  <span class="label label-danger pull-right">{{ $mails->count() }}</span>Trash</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <!-- /.col -->
        <form name="formAdd" id="formAdd" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            $(document).ready(function () {
              ...
              <div class="box-footer">
                <div class="pull-right">
                  ...
                  <button type="submit" class="btn btn-primary"id="butsave"><i class="fa fa-envelope-o"></i> Send</button>
                </div>

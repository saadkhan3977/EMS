            ...
            {{-- <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="{{ url('admin/mailbox') }}"><i class="fa fa-inbox"></i> Inbox
                  <span class="label label-primary pull-right">{{ $trashes->count() }}</span></a></li>
                <li><a href="{{ url('admin/mailbox/sent') }}"><i class="fa fa-envelope-o"></i>
                  <span class="label label-success pull-right">{{ $trashes->count() }}</span> Sent</a></li>
                <li><a href="#"><i class="fa fa-file-text-o"></i> 
                  <span class="label label-warning pull-right">{{ $trashes->count() }}</span> Drafts</a></li>
                </li>
                <li><a href="#"><i class="fa fa-trash-o"></i> 
                  <span class="label label-danger pull-right">{{ $trashes->count() }}</span>Trash</a></li>
              </ul>
            </div> --}}
            <!-- /.box-body -->
          </div>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="mailbox-name"><a href="/admin/trash/{{$trash->id}}">{{ $trash['trash'] }}</a></td>

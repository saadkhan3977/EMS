                ...
                <table id="dtMaterialDesignExample" class="table table-striped" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="/mailbox/{{ $mail->id }}/index_detail">{{ $mail->user->name }}</a></td>
                      ...
                      {{-- <td>
                        <a href="{{ url('myproducts',$mail->id) }}" class="btn btn-danger btn-sm"
                           data-tr="tr_{{$mail->id}}"
...
//            $last_row1 = DB::table('mail_send')->where('mail_id',$mailid)->get();
                    ...
                    <tr>
                      ...
                      {{-- <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td> --}}
                      <td class="mailbox-name"><a href="/mailbox/{{ $sent->id }}/sent_detail">To: {{ $sent->to }}</a></td>
                    ...
                    @endforeach
                    @else
                    <div class="alert alert-danger">No Mail Found..!</div>
                    @endif
                  </tbody>
                </table>
                <!-- /.table -->
        ...
        @elseif($url == url('/mailbox/create'))
        <form name="formAdd" id="formAdd" method="POST" action="{{ url('mailbox/store') }}" enctype="multipart/form-data">
          @csrf
